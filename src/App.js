...
<div className = "box">  
<div className = "content">
  <h2>Nikolay Posrednikov <br/><span>Dantist</span>  </h2>
  <ul>
...
<ul>
    <li>Больница: <span>Областная центральная поликнилинка</span></li>
    <li>Адрес: <span>Улица Аравийская Д.7 КВ.72</span></li>
  </ul>
  <button>Patients</button>
  </div> */}